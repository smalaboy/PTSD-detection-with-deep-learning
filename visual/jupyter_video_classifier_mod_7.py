...
train_s =  CustomDataGen("train.csv", 6, "new_npy")
val_s = CustomDataGen("validation.csv", 3, "new_npy")
test_s = CustomDataGen("test.csv", 4, "new_npy")
# print(X.shape)
...
log_dir = "tfb_logs/fit/" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
tensorboard_callback = tf.keras.callbacks.TensorBoard(log_dir=log_dir, histogram_freq=1)

history1 = model.fit(train_s, epochs=200, validation_data=val_s, callbacks=[model_checkpoint_callback, tensorboard_callback, lr_scheduler])
test_history = model.evaluate(test_s)
test_df = pd.DataFrame(test_history)
hist_csv_file = 'test_hist.csv'
...
model.save('ptsd_model_video.h5')
